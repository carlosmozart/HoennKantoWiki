    ...
    if (tabName === 'overview') {
        html += `
            <div class="grid-card bento-item" style="padding: 30px; text-align: center;">
                ...
                <img src="${window.FRONTIER_DATA.overview.image}" alt="Battle Frontier" loading="lazy" decoding="async" style="width:100%; max-width:900px; height:auto; margin-bottom: 30px; border-radius:15px; box-shadow:0 8px 24px rgba(0,0,0,0.6);">
